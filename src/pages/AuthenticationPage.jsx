  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-50 px-4">
      ...
      >
        ...
        <motion.button
          layout
          className="w-full flex items-center justify-center gap-3 h-12 border-2 border-gray-100 rounded-xl hover:bg-gray-50 transition-colors font-medium text-gray-700"
        >
